...
Freelance software developer, based in Portugal, building practical tools for businesses:

- ⚙️ **Automations** between your tools (calendar, invoicing, CRM, APIs) so data moves on its own
- 📊 **Real-time dashboards** for the numbers that matter
- 🤖 **AI agents & RAG chatbots** that answer, qualify and book, around the clock
- 🌐 **Websites** built for Google and for AI search (ChatGPT, Gemini)
...
<p align="left">
  ...
  <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/vuejs/vuejs-original.svg" alt="Vue" width="36" height="36" />
